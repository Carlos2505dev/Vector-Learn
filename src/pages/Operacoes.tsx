...
const operations = [
  {
    ...
    applications: [
      "Velocidades: barco atravessando rio com correnteza",
      "Forças: múltiplas forças atuando em um objeto",
      "Deslocamentos: caminhada com várias direções"
    ]
  },
  {
    id: "subtracao",
    ...
    applications: [
      "Velocidade relativa: velocidade de A em relação a B",
      "Mudança de posição: deslocamento entre dois pontos",
      "Diferença de forças: força líquida"
    ]
  },
  {
    id: "produto-escalar",
...
const examples = [
  {
    ...
    solution: [
      "v⃗_resultante = v⃗_avião + v⃗_vento",
      "v⃗_resultante = (200, 0) + (0, 50) = (200, 50) km/h",
      "|v⃗_resultante| = √(200² + 50²) = √42500 = 206.2 km/h",
      "θ = arctan(50/200) = 14.04° norte do leste"
    ]
  },
  {
    ...
    <Layout>
      ...
      >
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Domine as operações fundamentais: soma, subtração, produto escalar e produto vetorial.
